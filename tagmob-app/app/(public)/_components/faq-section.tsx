    ...
    >
      <div className="mx-auto grid max-w-[84rem] gap-12 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1fr)] lg:gap-20">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <Reveal delay={80}>
            <p className="mt-5 max-w-sm text-[0.95rem] leading-relaxed text-slate-100 font-medium text-pretty">
                ...
                <div className="border-b border-white/10">
                  ...
                  >
                    ...
                    {item.resposta.map((paragrafo) => (
                      <p
                        key={paragrafo}
                        className="text-[0.925rem] leading-relaxed text-slate-100 font-medium text-pretty"
                      >
                        {paragrafo}
                      </p>
                    ))}
