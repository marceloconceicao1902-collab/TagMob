    ...
    <section className="relative overflow-hidden border-t border-white/[0.07] bg-ink-deep px-6 py-20 sm:px-10 lg:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-[84rem]">
        <div className="max-w-2xl">
          ...
          <Reveal delay={80}>
            <p className="mt-6 text-[0.95rem] leading-relaxed text-white/70 sm:text-base">
          ...
          {NOME_PARTES.map((parte, i) => (
            <Reveal key={parte.sigla} as="li" delay={i * 100}>
              ...
              >
                ...
                <p className="text-[0.9rem] leading-relaxed text-white/65">{parte.texto}</p>
              </div>
            </Reveal>
          ))}
        </ul>
        ...
        <Reveal delay={340}>
          <p className="mt-11 max-w-3xl text-[0.95rem] leading-relaxed text-white/70 sm:text-base">
